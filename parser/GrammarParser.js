...
var ruleNames =  [ "iden", "parameter", "parameters", "func", "forloop", 
...
GrammarParser.RULE_parameter = 1;
GrammarParser.RULE_parameters = 2;
GrammarParser.RULE_func = 3;
GrammarParser.RULE_forloop = 4;
GrammarParser.RULE_whileloop = 5;
...
GrammarParser.prototype.parameter = function() {
    ...
    this.enterRule(localctx, 2, GrammarParser.RULE_parameter);
    try {
        this.state = 41;
...
GrammarParser.prototype.parameters = function() {
    ...
    this.enterRule(localctx, 4, GrammarParser.RULE_parameters);
...
GrammarParser.prototype.func = function() {
    ...
    this.enterRule(localctx, 6, GrammarParser.RULE_func);
    try {
        this.state = 68;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
GrammarParser.prototype.forloop = function() {
    ...
    this.enterRule(localctx, 8, GrammarParser.RULE_forloop);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 70;
...
GrammarParser.prototype.whileloop = function() {
    ...
    this.enterRule(localctx, 10, GrammarParser.RULE_whileloop);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 76;
